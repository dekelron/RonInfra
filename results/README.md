...
| [`vgg16-r50-s1-caffe`](vgg16-r50-s1-caffe/notes.md) | VGG-16, trained | 50 | converted Caffe | conv median λ **+1.023** | Seed 1 of the VGG-16 sweep. Gives VGG-16 its own noise floor: conv-median sd 0.014 (tv) / **0.003** (Caffe) over 3 seeds, against a lineage effect **22×** that. |
| [`vgg16-r50-s1`](vgg16-r50-s1/notes.md) | VGG-16, trained | 50 | `IMAGENET1K_V1` | conv median λ **+0.665** | Seed 1 of the VGG-16 sweep. Gives VGG-16 its own noise floor: conv-median sd 0.014 (tv) / **0.003** (Caffe) over 3 seeds, against a lineage effect **22×** that. |
| [`vgg16-r50-s2-caffe`](vgg16-r50-s2-caffe/notes.md) | VGG-16, trained | 50 | converted Caffe | conv median λ **+1.029** | Seed 2 of the VGG-16 sweep. Gives VGG-16 its own noise floor: conv-median sd 0.014 (tv) / **0.003** (Caffe) over 3 seeds, against a lineage effect **22×** that. |
| [`vgg16-r50-s2`](vgg16-r50-s2/notes.md) | VGG-16, trained | 50 | `IMAGENET1K_V1` | conv median λ **+0.676** | Seed 2 of the VGG-16 sweep. Gives VGG-16 its own noise floor: conv-median sd 0.014 (tv) / **0.003** (Caffe) over 3 seeds, against a lineage effect **22×** that. |
