# vgg19-scramble-r50-s1-in1k

`vgg19`, 50 reps/cell, best mean R² 0.941 at `features.19`.

## What this run was for

Scramble-seed sweep: seed 1 at IMAGENET1K_V1/50 reps, to test whether the control value is stable across seeds

## What it showed

`prob` mean R² = **0.863**, spacing CV 1.42. One of four permutations
...
gap of **0.050**. Across the four seeds that gap ranges 0.050–0.220, so no
...
```
run.py --model vgg19 --reps 50 --seed 1 --save-run results/vgg19-scramble-r50-s1-in1k --notes Scramble-seed sweep: seed 1 at IMAGENET1K_V1/50 reps, to test whether the control value is stable across seeds --figures out/ --scramble
```
