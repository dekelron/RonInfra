...
|---|---|---|---|---|---|---|---|
| +0.31 | +0.14 | -0.05 | -0.13 | -0.16 | -0.43 | +0.17 | +0.19 |

Bands: low (1, 1.75) **+0.23**, mid (7–28) **-0.24**,
high (56, 75) **+0.18** — so this run dips in the mid band,
**0.42** below both ends. λ at `prob` = +0.050 at λ-R² 0.984,
mean R² 0.961.
